...
class SwiftFramework_Admin {
	  ...
	  ?>
		<div class="sf-about-wrap">
			...
			<div class="about-content">
				...
				<h3>Previous Update (v2.5.45)</h3>
				<p></p>
				<ul>
					<li>FRONTEND: Added Testimonial Slider Cite image.</li>
					<li>FRONTEND: Added plugin + theme version body class output for faster support.</li>
					<li>FRONTEND: Fixed issue with column responsive visibility not working when extra class specified.</li>
					<li>FRONTEND: Fixed row column vertical align issue in IE Edge.</li>
					<li>FRONTEND: Fixed carousel showcase issue.</li>
					<li>FRONTEND: Fixed client image sizes.</li>
					<li>FRONTEND: Switched from matchheight to equalheights for firefox support.</li>
					<li>MISC: Change language file to be .pot and updated strings.</li>
				</ul>
			</div>
		</div>
	  <?php
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( 'material', plugin_dir_url( __FILE__ ) . 'css/lib/material.min.css', array(), current_time( 'timestamp' ) , 'all' );
